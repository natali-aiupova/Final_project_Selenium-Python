...
class ProductPage(BasePage):
    ...
    # Вызываем проверки 1) и 2).
    def should_be_correct_add_product_to_cart(self):
        self.should_be_correct_product_name()
        self.should_be_correct_product_price()

    # 1) Название товара в сообщении должно совпадать с тем товаром, который вы действительно добавили.
    ...
    # Проверка, что на странице нет сообщения об успехе
